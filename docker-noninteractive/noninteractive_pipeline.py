...
if __name__ == "__main__":
    ...
    rk3576 compatible qtypes:
    platform = "rk3576"
    qtypes = {"w8a8", "w4a16", "w4a16_g32", "w4a16_g64", "w4a16_g128"}
    Setting the pipline inside of the class, and then executing a loop in the global context
    Prevents the conversion/build process from quitting the entire script if one step fails
